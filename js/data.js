const about_description = ["I am a second-year student, majoring in Computer Science, at NYU School of Engineering. I aspire to combine my passions in programming and engineering by exploring fields such as IoT and robotics. During my free time, I enjoy creating projects in assistive technology and community using IoT with Arduino/Raspberry Pi and cloud computing along with iOS app development. During my first year in college, I worked on multiple hackathon projects and developed a prototype for an assistive technology to increase the accessibility of navigation for blind individuals by utilizing cloud computing and Raspberry. This semester, I am exploring a wider field of computer vision in self-driving cars and serving as a teaching assistant to mentor students on their open-ended projects that solve real-world problems. Through these experiences, I hope to become a far-reaching entrepreneur, mentor, and more importantly an effective problem solver."]
